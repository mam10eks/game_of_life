...
DOCKER_FILE="${DOCKER_FILE}COPY assets/beehive.png /usr/share/nginx/html/\n"
DOCKER_FILE="${DOCKER_FILE}COPY assets/blinker_pattern.gif /usr/share/nginx/html/\n"
DOCKER_FILE="${DOCKER_FILE}COPY assets/block.png /usr/share/nginx/html/\n"
DOCKER_FILE="${DOCKER_FILE}COPY assets/boat.png /usr/share/nginx/html/\n"
DOCKER_FILE="${DOCKER_FILE}COPY assets/loaf.png /usr/share/nginx/html/\n"
DOCKER_FILE="${DOCKER_FILE}COPY assets/toad_pattern.gif /usr/share/nginx/html/\n"
DOCKER_FILE="${DOCKER_FILE}COPY assets/tub.png /usr/share/nginx/html/\n"
